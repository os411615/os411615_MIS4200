...
namespace os411615_MIS4200.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "appointmentID,appointmentDate,patientID,doctorID")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "appointmentID,appointmentDate,patientID,doctorID")] Appointment appointment)
        {
            if (ModelState.IsValid)
            {
